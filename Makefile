...
KIND_CLUSTER ?= chaos-scheduler-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name chaos-scheduler-operator-builder
	$(CONTAINER_TOOL) buildx use chaos-scheduler-operator-builder
	...
	- $(CONTAINER_TOOL) buildx rm chaos-scheduler-operator-builder
	rm Dockerfile.cross
